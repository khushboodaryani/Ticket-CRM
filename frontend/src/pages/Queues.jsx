                            ...
                            <div key={q.id} className="card" style={{ 
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
                                    {[
                                        ...
                                        <div key={i} style={{ padding: '12px 8px', background: 'var(--bg-app)', borderRadius: 12, border: '1px solid var(--border)', textAlign: 'center' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 12, marginTop: 4 }}>
                                    <button className="btn btn-block btn-secondary" onClick={() => openAgentPanel(q)} style={{ borderRadius: 12 }}>Manage Team</button>
                                    <div style={{ display: 'flex', gap: 8 }}>
                                        ...
                                        <button className="btn btn-icon btn-danger" onClick={() => handleDelete(q.id)} style={{ borderRadius: 12 }} title="Delete">
